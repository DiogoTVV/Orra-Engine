...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addNoteUI():Void
	{
		...
		var noteTypeDropDown = new FlxUIDropDownMenu(10, 50, FlxUIDropDownMenu.makeStrIdLabelArray(noteTypes, true), function(character:String)
		{
			curNoteType = noteTypes[Std.parseInt(character)];
		});
	...
	private function addNote():Void
	{
		...
		var noteSus = 0;
		var noteType:String = curNoteType;
