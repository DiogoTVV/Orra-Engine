...
class Character extends FlxSprite
{
	...
	{
		var formatAnim:String = AnimName;
		if(animation.getByName(AnimName) == null)
			formatAnim = formatAnim.replace('miss', '');
		if(animation.getByName(formatAnim) == null)
			return;
		
		animation.play(formatAnim, Force, Reversed, Frame);

		var daOffset = animOffsets.get(formatAnim);
		if (animOffsets.exists(formatAnim))
